...
public class AdminToolsMod implements ModInitializer {
    ...
    private void registerScreenHandlers() {
        Registry.register(Registries.SCREEN_HANDLER, Identifier.of(MOD_ID, "invsee"), InvSeeScreenHandler.TYPE);
        Registry.register(Registries.SCREEN_HANDLER, Identifier.of(MOD_ID, "endersee"), EnderSeeScreenHandler.TYPE);
    }
